//
// THIS IS DEPRECATED FILE, I AM GOING TO DELETE THIS LATER ON, BUT I WANT TO KEEP THIS UNTIL I TEST THAT ALL CHANGES TO NEW CODE ARE FIXED AND FUNCTIONAL
//
...
function main_app(backup_db: any = undefined){
    ...
    if (backup_db){
        ...
        for (let i = 0; i < backup_db["planes"].length; i++){
            ...
            let plane = new Plane(curr_plane_id, backup_dEvLoggerb["planes"][i]["callsign"], 
